...
Docker Python 镜像，提供标准化的容器基础，具有灵活的入口点系统、多架构支持以及跨 Alpine、Debian 和 Rocky Linux 发行版的一致配置模式。

## 概述

Docker Python 镜像作为构建容器化应用程序的基础起点。它提供：
...
- `snowdreamtech/python:3.14.7-alpine`
- `snowdreamtech/python:3.12.13-rocky`

此格式允许：

- **完整版本固定**：`3.13.5-debian`（精确版本）
